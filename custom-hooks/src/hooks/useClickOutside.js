...
Compared to scroll listeners, it's more efficient because the browser handles the observation internally instead 
of running calculations on every scroll event.
...
For visibility detection, yes. IntersectionObserver is purpose-built for that problem and generally performs better
than manually throttling scroll events.
...
Lazy Loading Images
Analytics Tracking
Why better than scroll listeners?

Browser handles observation efficiently.
*/